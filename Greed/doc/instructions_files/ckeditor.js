...
sakai.editor.editors.ckeditor.launch = function(targetId, config, w, h) {
    ...
    var ckconfig = {
        ...
        [
            ...
            (sakai.editor.enableResourceSearch
                ...
                : ['Image','Movie','Flash','Table','HorizontalRule','Smiley','SpecialChar','fmath_formula','Video']),
            '/',
    ...
    if (config) {
		...
		(function() { 
		   ...
		   CKEDITOR.plugins.addExternal('video',basePath+'video/', 'plugin.js');
			 /*
			 ...
			 */
			 ...
			 ckconfig.extraPlugins+="movieplayer,wordcount,fmath_formula,video";
    })();
